                ...
                <form action="{{ route('admin.blogs.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="pt-4 px-6">
                        ...
                        <div class="mb-6">
                            ...
                            <input class="block w-full px-4 py-3 mb-2 text-sm bg-white border rounded" type="text"
                                id="title" name="title" value="{{ old('title') }}">
                        </div>

                        <div class="mb-6">
                            <label class="block text-sm mb-2" for="image">画像</label>
                            <div class="flex items-end">
                                <img id="previewImage" src="/images/admin/noimage.jpg"
                                    data-noimage="/images/admin/noimage.jpg" alt="" class="rounded shwdow-md w-64">
                                <input class="block w-full px-4 py-3 mb-2" type="file" id="image" accept="image/*"
                                    name="image">
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea class="block w-full px-4 py-3 mb-2 text-sm bg-white border rounded" name="body" id="body"
